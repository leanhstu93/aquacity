...
<div class="page-header">
    <h1 class="title">Quản lý loạithư viện ảnh</h1>
    <ol class="breadcrumb">
        <li><a href="/admin">Home</a></li>
        <li class="active"><a href="<?php echo Yii::app()->homeUrl ?>admin/quan-ly-loai-thu-vien-anh.html">Danh sách loạithư viện ảnh </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default ad-qllt">
                <div class="panel-title">
                    <h1>Quản lý loạithư viện ảnh</h1>
                    <ul class="panel-tools">
                        <li><a class="icon expand-tool"><i class="fa fa-expand"></i></a></li>
                    </ul>
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-loai-thu-vien-anh.html">Thêm loạithư viện ảnh</a>
                </div>
