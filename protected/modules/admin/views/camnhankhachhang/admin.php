...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Quản lý cảm nhận khách hàng</li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-title">
                    <h1>Quản lý cảm nhận khách hàng</h1>
                    <ul class="panel-tools">
                        <li><a class="icon expand-tool"><i class="fa fa-expand"></i></a></li>
                    </ul>
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-cam-nhan-khach-hang.html">Thêm cảm nhận khách hàng</a>
                </div>
                    ...
                    <div id="example0_wrapper" class="dataTables_wrapper">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'ThongTinCaNhan',
                                    'filter' => CHtml::textField('ThongTinCaNhan', Yii::app()->request->getParam('    ThongTinCaNhan')),
                                    ),
                                 array(
                                    'name'=>'UrlImage',
                                    'type'=>"raw",
