...
<div class="form-group" style="margin-bottom:0px">
    <label class="col-sm-2 control-label form-label" for="input001">Thông tin cá nhân:</label>
    <div class="col-sm-6">
        <?php echo $form->textField($model,'ThongTinCaNhan',array('size'=>60,'maxlength'=>100,'class'=>'form-control' )); ?>
        <span class="help-block" id="helpBlock"><?php echo $form->error($model,'ThongTinCaNhan',array("text"=>"aaa")); ?></span> 
    </div>
</div>
<div class="form-group" style="margin-bottom:0px">
    <label class="col-sm-2 control-label form-label" for="input001">Tiêu đề:</label>
    <div class="col-sm-6">
        <?php echo $form->textField($model,'TieuDe',array('size'=>60,'maxlength'=>100,'class'=>'form-control' , 'required' => 'required')); ?>
        <span class="help-block" id="helpBlock"><?php echo $form->error($model,'TieuDe',array("text"=>"aaa")); ?></span> 
    </div>
</div>
<div class="form-group" style="margin-bottom:0px">
...
<div class="form-group" style="margin-bottom:0px">
    ...
    <div class="col-sm-6">
        ...
        <span class="help-block" id="helpBlock"><?php echo $form->error($model,'Content',array("text"=>"aaa")); ?></span> 
    </div>
</div>
<div class="form-group" style="margin-bottom:0px">
    ...
    <div class="form-group" style="margin-bottom:0px">
     ...
     <div class="form-group" style="margin-bottom:0px">
        ...
        <div class="col-sm-6">
            ...
            <span class="help-block" id="helpBlock"><?php echo $form->error($model,'Seo_Keyword',array("text"=>"aaa")); ?></span> </div>
    </div>
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Thêm cảm nhận khách hàng' : 'Lưu cảm nhận khách hàng'); ?>
    </div>
</div>
<script>
    ...
    {
        jQuery('#Camnhankhachhang_UrlImage').val(url);
