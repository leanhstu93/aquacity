        ...
        <div class="panel-body">
            <?php foreach ($data as $key_parent => $item){?>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="Custom[CUSTOM_LIBRARY_IMAGE][<?php echo $key_parent ?>][data]" class="selectpicker">
                            <?php
                            $criteria=new CDbCriteria();
                            $criteria->condition = "active = 1";
                            $loai_hinh_anh= Loaithuvienanh::model()->findAll($criteria);
