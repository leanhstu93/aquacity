...
<div class="form-group" style="margin-bottom:0px">
    <?php echo $form->labelEx($model, 'Footer', array('class' => 'col-sm-2 control-label form-label')); ?>
    <div class="col-sm-6">
          <?php         
          echo $form->dropDownList($model, 'Footer',array("Không","Có"), array( 'class' => 'form-control ')); ?>
        <span class="help-block" id="helpBlock"><?php echo $form->error($model, 'Footer'); ?></span> </div>
</div>
