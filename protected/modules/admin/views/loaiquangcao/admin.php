...
<div class="page-header">
    <h1 class="title">Quản lý loại quảng cáo</h1>
    <ol class="breadcrumb">
        <li><a href="/admin">Home</a></li>
        <li class="active"><a href="<?php echo Yii::app()->homeUrl ?>admin/quan-ly-loai-quang-cao.html">Quản lý loại quảng cáo </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default ad-qllt">
                <div class="panel-title">
                    <h1>Quản lý loại quảng cáo</h1>
                    <ul class="panel-tools">
                        <li><a class="icon expand-tool"><i class="fa fa-expand"></i></a></li>
                    </ul>
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-loai-quang-cao.html">Thêm loại quảng cáo</a>
                </div>
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'update' => array(
                                            ...
                                            'url' =>'Yii::app()->homeUrl."admin/sua-loai-quang-cao/".$data->id.".html"'
                                        ),
                                        'delete' => array(
                                            'label' => '',
                                            'imageUrl' => '',
