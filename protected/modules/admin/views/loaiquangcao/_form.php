<?php
 $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="form-group" style="margin-bottom:0px">
        <?php echo $form->labelEx($model, 'idLoaiHienThi', array('class' => 'col-sm-2 control-label form-label')); ?>
        <div class="col-sm-6">
             
              <?php
              echo $form->dropDownList($model, 'idLoaiHienThi',array(1=>"TRANG CHỦ - phải - 2",4=>"CHUYÊN MỤC - phải - 2",7=>"BÀI VIẾT - phải - 2",8=>"BÀI VIẾT - phải - 3"), array( 'class' => 'form-control ')); ?>
            <span class="help-block" id="helpBlock"><?php echo $form->error($model, 'idLoaiHienThi'); ?></span> </div>
    </div>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Thêm loại quảng cáo' : 'Lưu loại quảng cáo'); ?>
    </div>
</div>
