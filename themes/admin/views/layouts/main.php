    ...
    <body>
        ...
        <div class="sidebar clearfix">
            ...
            <ul class="sidebar-panel nav">
                ...
                <li><a  class="active" href="<?php echo Yii::app()->homeUrl ?>admin"><span class="icon color5"><i class="fa fa-home"></i></span>Quản lý chung</a></li>
            ...
            <ul class="sidebar-panel nav">
               ...
               <li class="cntt"><a href="<?php echo Yii::app()->request->baseUrl ?>/admin/cap-nhat-thong-tin.html"><span class="icon color9"><i class="fa fa-list-alt"></i></span> Thông tin công ty </a></li>
                ...
                <li class="qlbl"><a href="<?php echo Yii::app()->request->baseUrl ?>/admin/quan-ly-tin-tuc.html"><span class="icon color15"><i
                  ...
                  <li class="qlbl"><a href="<?php echo Yii::app()->request->baseUrl ?>/admin/quan-ly-cam-nhan-khach-hang.html"><span class="icon color15"><i
                        class="fa fa-list-alt"></i></span>Quản lý cảm nhận  </a></li>
                 <li class="qlqc"><a href="<?php echo Yii::app()->request->baseUrl ?>/admin/quan-ly-slide.html"><span class="icon color15"><i class="fa fa-list-alt"></i></span>Quản lý slide   </a></li>
                 <?php 
                ...
                $dh = Baogia::model()->count($criteria);
                  ?> 
                 <li class="qlqc"><a href="<?php echo Yii::app()->request->baseUrl ?>/admin/quan-ly-nhan-bao-gia.html"><span class="icon color15"><i class="fa fa-list-alt"></i><span class="count-dh <?php echo $dh > 0 ? 'active' : '' ?>"><?php echo $dh ?></span></span>Quản lý nhận báo giá   </a></li>
        ...
        .count-dh{
            ...
            <div class="row footer">
                <div class="col-md-6 text-left">
                    Copyright © 2015 <a href="#" target="_blank">ngoisaoxanh.com.vn</a> All
                    rights reserved.
                </div>
                <div class="col-md-6 text-right">
                    Design and Developed by <a href="#" target="_blank">ngoisaoxanh.com.vn</a>
                </div>
            </div>
            <!-- End Footer -->
